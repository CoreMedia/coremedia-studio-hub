...
public class EncryptUtils {
    ...
    protected static String encrypt(String property) throws GeneralSecurityException {
        ...
        return Base64.getMimeEncoder().encodeToString(pbeCipher.doFinal(property.getBytes(StandardCharsets.UTF_8)));
    }
    ...
    protected static String decrypt(String property) throws GeneralSecurityException, IOException {
        ...
        return new String(pbeCipher.doFinal(Base64.getMimeDecoder().decode(property)), StandardCharsets.UTF_8);
    }
}
