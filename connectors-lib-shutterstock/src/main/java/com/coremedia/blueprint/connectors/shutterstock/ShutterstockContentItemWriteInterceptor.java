 ...
 *
 */
public class ShutterstockContentItemWriteInterceptor extends ConnectorItemWriteInterceptor {
  ...
  public void intercept(ContentWriteRequest request) {
    ...
    if (properties.containsKey(CONNECTOR_ENTITY)) {
      ...
      if (entity instanceof ShutterstockConnectorPicture) {
        ShutterstockConnectorPicture video = (ShutterstockConnectorPicture) entity;
